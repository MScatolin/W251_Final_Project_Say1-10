...
1. Install the Nvidia GPU driver for your GPU and OS
2. Install docker 19.03 or above
3. Install Nvidia container toolkit [Totorial](https://github.com/NVIDIA/nvidia-docker/blob/master/README.md#quickstart)
4. Build docker image
```
docker build -t lipnet .
```
5. Start the container and notebook
```
docker run --rm -d --name lipnet_nb --privileged --gpus all -v $PWD:/app -p 6006:6006 -p 8888:8888 -t lipnet jupyter notebook

## get the token
docker logs lipnet_nb
```
